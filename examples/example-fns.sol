...
string constant SESSION_NOTATION = "Session(address account,address smartSession,uint8 mode,address sessionValidator,bytes32 salt,bytes sessionValidatorInitData,PolicyData[] userOpPolicies,ERC7739Data erc7739Policies,ActionData[] actions)";
...
library HashLib {
    ...
    function multichainDigest(
        ChainDigest[] memory hashesAndChainIds
     ...
     */
    function hashChainDigestMimicRPC(
    ...
    function getAndVerifyDigest(
        ...
        uint64 providedChainId = enableData
            .hashesAndChainIds[enableData.chainDigestIndex]
            .chainId;
        bytes32 providedHash = enableData
            .hashesAndChainIds[enableData.chainDigestIndex]
            .sessionDigest;
